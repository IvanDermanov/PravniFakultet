...
public class StudentDao {
	...
	static {
		...
		studenti = new HashMap<String, Student>() {
			...
			{
				put("125/2018", new Student("Petar", "Petrovic","НБ",125,2018,"1306989361035","13.06.1989","",1));
				put("126/2018", new Student("Petar", "Petrovic","О",126,2018,"1306989361035","13.06.1989","",1));
				put("127/2018", new Student("Petar", "Petrovic","С",127,2018,"1306989361035","13.06.1989","",1));
				put("128/2018", new Student("Petar", "Petrovic","ДЈ",128,2018,"1306989361035","13.06.1989","",1));
